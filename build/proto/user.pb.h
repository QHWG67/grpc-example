...
PROTOBUF_NAMESPACE_OPEN
template<> ::example::UserRequest* Arena::CreateMaybeMessage<::example::UserRequest>(Arena*);
template<> ::example::UserResponse* Arena::CreateMaybeMessage<::example::UserResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace example {
...
class UserRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:example.UserRequest) */ {
 public:
...
class UserResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:example.UserResponse) */ {
 public:
...
inline uint32_t UserRequest::_internal_id() const {
  return _impl_.id_;
}
inline uint32_t UserRequest::id() const {
  // @@protoc_insertion_point(field_get:example.UserRequest.id)
  return _internal_id();
}
inline void UserRequest::_internal_set_id(uint32_t value) {
  
  _impl_.id_ = value;
}
inline void UserRequest::set_id(uint32_t value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:example.UserRequest.id)
}
...
inline const std::string& UserResponse::name() const {
  // @@protoc_insertion_point(field_get:example.UserResponse.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void UserResponse::set_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:example.UserResponse.name)
}
inline std::string* UserResponse::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:example.UserResponse.name)
  return _s;
}
inline const std::string& UserResponse::_internal_name() const {
  return _impl_.name_.Get();
}
inline void UserResponse::_internal_set_name(const std::string& value) {
  
  _impl_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* UserResponse::_internal_mutable_name() {
  
  return _impl_.name_.Mutable(GetArenaForAllocation());
}
inline std::string* UserResponse::release_name() {
  // @@protoc_insertion_point(field_release:example.UserResponse.name)
...
inline void UserResponse::set_allocated_name(std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:example.UserResponse.name)
}
...
inline const std::string& UserResponse::email() const {
  // @@protoc_insertion_point(field_get:example.UserResponse.email)
...
void UserResponse::set_email(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.email_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:example.UserResponse.email)
}
inline std::string* UserResponse::mutable_email() {
  std::string* _s = _internal_mutable_email();
  // @@protoc_insertion_point(field_mutable:example.UserResponse.email)
  return _s;
}
...
inline std::string* UserResponse::release_email() {
  // @@protoc_insertion_point(field_release:example.UserResponse.email)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:example.UserResponse.email)
}
