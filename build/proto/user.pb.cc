...
const uint32_t TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::example::UserRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::example::UserRequest, _impl_.id_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::example::UserResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::example::UserResponse, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::example::UserResponse, _impl_.email_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::example::UserRequest)},
  { 7, -1, -1, sizeof(::example::UserResponse)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::example::_UserRequest_default_instance_._instance,
  &::example::_UserResponse_default_instance_._instance,
};
...
UserRequest::UserRequest(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:example.UserRequest)
}
UserRequest::UserRequest(const UserRequest& from)
  ...
  // @@protoc_insertion_point(copy_constructor:example.UserRequest)
}
...
UserRequest::~UserRequest() {
  // @@protoc_insertion_point(destructor:example.UserRequest)
...
// @@protoc_insertion_point(message_clear_start:example.UserRequest)
...
uint8_t* UserRequest::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:example.UserRequest)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:example.UserRequest)
  return target;
}

size_t UserRequest::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:example.UserRequest)
  size_t total_size = 0;
...
void UserRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:example.UserRequest)
...
// @@protoc_insertion_point(class_specific_copy_from_start:example.UserRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
UserResponse::UserResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:example.UserResponse)
}
UserResponse::UserResponse(const UserResponse& from)
  ...
  // @@protoc_insertion_point(copy_constructor:example.UserResponse)
}
...
UserResponse::~UserResponse() {
  // @@protoc_insertion_point(destructor:example.UserResponse)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:example.UserResponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "example.UserResponse.name"));
        } else
          goto handle_unusual;
        continue;
      // string email = 2;
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "example.UserResponse.email"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* UserResponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:example.UserResponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:example.UserResponse)
  return target;
}

size_t UserResponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:example.UserResponse)
  size_t total_size = 0;
...
void UserResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:example.UserResponse)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:example.UserResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::example::UserRequest*
Arena::CreateMaybeMessage< ::example::UserRequest >(Arena* arena) {
  return Arena::CreateMessageInternal< ::example::UserRequest >(arena);
}
template<> PROTOBUF_NOINLINE ::example::UserResponse*
Arena::CreateMaybeMessage< ::example::UserResponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::example::UserResponse >(arena);
}
